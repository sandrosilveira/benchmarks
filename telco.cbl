      ...
      *>
       ...
       01  Misc.
           ...
           05.
               10 Start-Time.
                  15 filler     Pic X(8).
                  15 Start-hou  Pic 9(2).
                  15 Start-min  Pic 9(2).
                  15 Start-sec  Pic 9(2).
                  15 Start-cen  Pic 9(2).
                  15 filler     Pic X(5).
               10  End-Time.
                  15 filler     Pic X(8).
                  15 End-hou    Pic 9(2).
               ...
               10  Elapsed-Time.
                  15 filler     Pic X(8).
                  15 Elapsed-hou Pic 9(2).
                  15 Elapsed-min Pic 9(2).
                  15 Elapsed-sec Pic 9(2).
                  15 Elapsed-cen Pic 9(2).
                  15 filler     Pic X(5).
       01  Misc-Num.
      ...
      &        "------------".
       ...
       WindUp.
           ...
           compute elapsed = ((End-hou * 3600 + End-min * 60 + End-sec) * 100 + End-cen) -
                             ((Start-hou * 3600 + Start-min * 60 + Start-sec) * 100 + Start-cen)
           compute Elapsed-hou = elapsed / 3600 / 100
           compute elapsed = elapsed - (Elapsed-hou * 3600 * 100)
           compute Elapsed-min = elapsed / 60 / 100
           compute elapsed = elapsed - (Elapsed-min * 60 * 100)
           compute Elapsed-sec = elapsed / 100
           compute elapsed = elapsed - (Elapsed-sec * 100)
           move elapsed to Elapsed-cen

           String       "Elapsed-Time:"         Delimited by Size
                        Elapsed-Time (9:2)      Delimited by Size
                        ":"                     Delimited by size
                        Elapsed-Time (11:2)     Delimited by size
                        ":"                     Delimited by size
                        Elapsed-Time (13:2)     Delimited by size
                        "."                     Delimited by size
                        Elapsed-Time (15:2)     Delimited by size
                into OutRec
           display OutRec
           Write OutRec
